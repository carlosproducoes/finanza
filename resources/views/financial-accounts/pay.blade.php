            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="overflow-x-auto">
                        ...
                        <form action="{{ route('financial-accounts.process', $financialAccount->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="payment_date" class="block mt-1 w-full"
                                                type="date"
                                                name="payment_date"
                                                value="{{ old('payment_date', $financialAccount->payment_date ?? '') }}" 
                                                required />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="paid_amount" class="block mt-1 w-full"
                                                type="number"
                                                name="paid_amount"
                                                value="{{ old('paid_amount', $financialAccount->paid_amount ?? '') }}"
                                                step="0.01" 
                                                min="0"
                                                required />
