                    ...
                    <div class="overflow-x-auto">
                        ...
                        <div class="mb-4">
                            <div class="flex justify-between items-center px-3 py-2 mb-3">
                                <a href="{{ route('transactions.index', ['date' => \Carbon\Carbon::createFromFormat('m-Y', $date)->subMonth()->format('m-Y')]) }}" class="text-xl"><</a>
                                    <h2 class="text-xl font-bold">{{ ucfirst(\Carbon\Carbon::createFromFormat('m-Y', $date)->monthName) }}</h2>
                                <a href="{{ route('transactions.index', ['date' => \Carbon\Carbon::createFromFormat('m-Y', $date)->addMonth()->format('m-Y')]) }}" class="text-xl">></a>
                            </div>
